...
TH2D *ChamberBXPos42 = new TH2D("Chamber vs BX ME+4/2", "Chamber vs BX ME+4/2",
                                36, 1, 37, 7, -3.5, 3.5);
TH2D *ChamberBXPos32 = new TH2D("Chamber vs BX ME+3/2", "Chamber vs BX ME+3/2",
                                36, 1, 37, 7, -3.5, 3.5);
TH2D *ChamberBXNeg42 = new TH2D("Chamber vs BX ME-4/2", "Chamber vs BX ME-4/2",
                                36, 1, 37, 7, -3.5, 3.5);
TH2D *ChamberBXNeg32 = new TH2D("Chamber vs BX ME-3/2", "Chamber vs BX ME-3/2",
                                36, 1, 37, 7, -3.5, 3.5);
TH2D *EtaBXPos42 = new TH2D("BX vs Eta ME+4/2", "BX vs Eta ME+4/2", 7, -3.5,
                            3.5, 40, 1.1, 1.8);
TH2D *EtaBXPos32 = new TH2D("BX vs Eta ME+3/2", "BX vs Eta ME+3/2", 7, -3.5,
                            3.5, 40, 1.1, 1.8);
TH2D *EtaBXNeg42 = new TH2D("BX vs Eta ME-4/2", "BX vs Eta ME-4/2", 7, -3.5,
                            3.5, 40, -1.8, -1.1);
TH2D *EtaBXNeg32 = new TH2D("BX vs Eta ME-3/2", "BX vs Eta ME-3/2", 7, -3.5,
                            3.5, 40, -1.8, -1.1);
...
TH1D *TrackLCTBX42HiPt = new TH1D("Track LCT BX 4/2 with hi Pt",
                                  "Track LCT BX with High Pt", 7, -3.5, 3.5);
TH1D *TrackBX = new TH1D("Track BX", "Track BX", 7, -3.5, 3.5);
TH1D *TrackNo42BX =
    new TH1D("Track no 42 BX", "Track with no 4/2 BX", 7, -3.5, 3.5);
TH1D *TrackBXHiPt =
    new TH1D("Track BX with Hi Pt", "Track BX with High Pt", 7, -3.5, 3.5);
TH1D *TrackBXNo42HiPt =
    new TH1D("Track no 42 BX with Hi Pt", "Track BX with no 4/2 and High Pt", 7,
             -3.5, 3.5);
TH1D *HiPtPhi = new TH1D("High Pt Phi", "High Pt Phi", 100, -3.15, 3.15);
TH2D *BXvsPhi =
    new TH2D("BX vs Phi", "BX vs Phi", 7, -3.5, 3.5, 100, -3.15, 3.15);
TH2D *EtavsPhi =
    new TH2D("Eta vs Phi", "Eta vs Phi", 50, -2.5, 2.5, 100, -3.15, 3.15);
TH2D *HiPt_EtavsPhi = new TH2D("Hi Pt Eta vs Phi", "Hi Pt Eta vs Phi", 50, -2.5,
                               2.5, 100, -3.15, 3.15);
TH2D *HierPt_EtavsPhi = new TH2D("Hier Pt Eta vs Phi", "Hier Pt Eta vs Phi", 50,
                                 -2.5, 2.5, 100, -3.15, 3.15);
TH2D *TrackPtvsPhiPos42 = new TH2D("Pt vs Phi positive endcap", "Pt vs Phi",
                                   250, 1, 251, 100, -3.15, 3.15);
TH2D *TrackPtvsPhiNeg42 = new TH2D("Pt vs Phi negative endcap", "Pt vs Phi",
                                   250, 1, 251, 100, -3.15, 3.15);
// Chad's Timing plots////
//      :)START(:      //
/////////////////////////
...
TH1D *TrackPTdPhi =
    new TH1D("Track PT w/ dPhi", "Track PT w/ dPhi", 100, 1, 101);
TH1D *TrackPTdTheta =
    new TH1D("Track PT w/ dTheta", "Track PT w/ dTheta", 100, 1, 101);

TH2D *ME1vME2BX =
    new TH2D("ME1 vs ME2 BX", "ME1 vs ME2 BX", 7, -3.5, 3.5, 7, -3.5, 3.5);
TH2D *ME1vME3BX =
    new TH2D("ME1 vs ME3 BX", "ME1 vs ME3 BX", 7, -3.5, 3.5, 7, -3.5, 3.5);
TH2D *ME1vME4BX =
    new TH2D("ME1 vs ME4 BX", "ME1 vs ME4 BX", 7, -3.5, 3.5, 7, -3.5, 3.5);
TH2D *ME2vME3BX =
    new TH2D("ME2 vs ME3 BX", "ME2 vs ME3 BX", 7, -3.5, 3.5, 7, -3.5, 3.5);
TH2D *ME2vME4BX =
    new TH2D("ME2 vs ME4 BX", "ME2 vs ME4 BX", 7, -3.5, 3.5, 7, -3.5, 3.5);
TH2D *ME3vME4BX =
    new TH2D("ME3 vs ME4 BX", "ME3 vs ME4 BX", 7, -3.5, 3.5, 7, -3.5, 3.5);
TH2D *ME1vME2Phi = new TH2D("ME1 vs ME2 Phi", "ME1 vs ME2 Phi", 1500, 500, 2001,
                            1500, 500, 2001);
TH2D *ME1vME3Phi = new TH2D("ME1 vs ME3 Phi", "ME1 vs ME3 Phi", 1500, 500, 2001,
                            1500, 500, 2001);
TH2D *ME1vME4Phi = new TH2D("ME1 vs ME4 Phi", "ME1 vs ME4 Phi", 1500, 500, 2001,
                            1500, 500, 2001);
TH2D *ME2vME3Phi = new TH2D("ME2 vs ME3 Phi", "ME2 vs ME3 Phi", 1500, 500, 2001,
                            1500, 500, 2001);
TH2D *ME2vME4Phi = new TH2D("ME2 vs ME4 Phi", "ME2 vs ME4 Phi", 1500, 500, 2001,
                            1500, 500, 2001);
TH2D *ME3vME4Phi = new TH2D("ME3 vs ME4 Phi", "ME3 vs ME4 Phi", 1500, 500, 2001,
                            1500, 500, 2001);
TH2D *ME1vME2Theta =
    new TH2D("ME1 vs ME2 Theta", "ME1 vs ME2 Theta", 20, 1, 101, 20, 1, 101);
TH2D *ME1vME3Theta =
    new TH2D("ME1 vs ME3 Theta", "ME1 vs ME3 Theta", 20, 1, 101, 20, 1, 101);
TH2D *ME1vME4Theta =
    new TH2D("ME1 vs ME4 Theta", "ME1 vs ME4 Theta", 20, 1, 101, 20, 1, 101);
TH2D *ME2vME3Theta =
    new TH2D("ME2 vs ME3 Theta", "ME2 vs ME3 Theta", 20, 1, 101, 20, 1, 101);
TH2D *ME2vME4Theta =
    new TH2D("ME2 vs ME4 Theta", "ME2 vs ME4 Theta", 20, 1, 101, 20, 1, 101);
TH2D *ME3vME4Theta =
    new TH2D("ME3 vs ME4 Theta", "ME3 vs ME4 Theta", 20, 1, 101, 20, 1, 101);
int ME1BX;
int ME2BX;
int ME3BX;
int ME4BX;
...
////      :)START(:      //
///////////////////////////
TH2D *Station3dThetaCheck = new TH2D(
    "3 Station dTheta Check", "3 Station dTheta Check", 18, -1, 16, 10, -1, 8);
TH2D *Station4dThetaCheck = new TH2D(
    "4 Station dTheta Check", "4 Station dTheta Check", 18, -1, 16, 10, -1, 8);
...
TH1D *SingleMuPtLodBX1 =
    new TH1D("SingleMuonPtLodBX1", "SingleMuonPtLodBX1", 22, 1, 23);
TH1D *SingleMuPtLodBX1ME11 =
    new TH1D("SingleMuonPtLodBX1ME11", "SingleMuonPtLodBX1ME11", 22, 1, 23);

TH1D *SingleMuPtHi = new TH1D("SingleMuonPtHi", "SingleMuonPtHi", 78, 22, 101);
TH1D *SingleMuPtHidBX1 =
    new TH1D("SingleMuonPtHidBX1", "SingleMuonPtHidBX1", 78, 22, 101);
TH1D *SingleMuPtHidBX1ME11 =
    new TH1D("SingleMuonPtHidBX1ME11", "SingleMuonPtHidBX1ME11", 78, 22, 101);

TH1D *SingleMuPtAll =
    new TH1D("SingleMuonPtAll", "SingleMuonPtAll", 100, 1, 101);
TH1D *SingleMuPtAlldBX1 =
    new TH1D("SingleMuonPtAlldBX1", "SingleMuonPtAlldBX1", 100, 1, 101);
TH1D *SingleMuPtAlldBX1ME11 =
    new TH1D("SingleMuonPtAlldBX1ME11", "SingleMuonPtAlldBX1ME11", 100, 1, 101);

TH1D *SingleMuPtLoPattern =
    new TH1D("SingleMuonPtLoPattern", "SingleMuonPtLoPattern", 22, 1, 23);
TH1D *SingleMuPtHiPattern =
    new TH1D("SingleMuonPtHiPattern", "SingleMuonPtHiPattern", 78, 22, 101);
TH1D *SingleMuPtAllPattern =
    new TH1D("SingleMuonPtAllPattern", "SingleMuonPtAllPattern", 100, 1, 101);

/////Alex's PU rate study/////
/////      :)START(:      ////
//////////////////////////////
TH1D *EventPairCount = 
    new TH1D("EventPairCount", "EventPairCount", 100, 0, 100);
...
// EventPairCount->GetXaxis()->SetTitle("# of Pairs");
// EventPairCount->GetYaxis()->SetTitle("# of Events");

// SingleMuPtLoWPair->GetXaxis()->SetTitle("")
...
void Read_FlatNtuple() {
  ...
  // store.Data(), in_dir.Data());  std::cout << "Adding file " <<
  // file_name.Data() << std::endl;  in_file_names.push_back(file_name.Data());
  ...
  for (int iEvt = 0; iEvt < nEvents; iEvt++) {
    ...
    // Alex PU Study: Find events with pair LCTs with same chamber, BX, and phi, but differnet Theta
    int pairs = 0;
    for (int i = 0; i < I("nHits"); i ++) {
      for (int j = i + 1; j < I("nHits"); j ++) {
        if(I("hit_isCSC", i) == 1 && I("hit_isCSC", j) == 1) {
          // What about hits with same theta? Do I need to account for sector etc?
          bool isPair = 
            I("hit_endcap", i) == I("hit_endcap", j) &&
    ...
    EventPairCount->Fill(pairs, 1);

    for (int i = 0; i < I("nHits"); i++) {

      if (I("hit_isCSC", i) == 1) {
        if (verbose)
          std::cout << " * CSC LCT with BX = " << I("hit_BX", i)
                    << ", endcap = " << I("hit_endcap", i)
                    << ", station = " << I("hit_station", i)
                    << ", ring = " << I("hit_ring", i) << std::endl;
        ...
        if (I("hit_endcap", i) > 0 && I("hit_neighbor", i) == 0) {
          if (I("hit_station", i) == 4 && I("hit_ring", i) == 2)
            Pos42->Fill(I("hit_chamber", i), 1);
          if (I("hit_station", i) == 4 && I("hit_ring", i) == 1)
            Pos41->Fill(I("hit_chamber", i), 1);
          if (I("hit_station", i) == 3 && I("hit_ring", i) == 2)
            Pos32->Fill(I("hit_chamber", i), 1);
          if (I("hit_station", i) == 3 && I("hit_ring", i) == 1)
            Pos31->Fill(I("hit_chamber", i), 1);
          if (I("hit_station", i) == 2 && I("hit_ring", i) == 2)
            Pos22->Fill(I("hit_chamber", i), 1);
          if (I("hit_station", i) == 4 && I("hit_ring", i) == 2)
            ChamberBXPos42->Fill(I("hit_chamber", i), I("hit_BX", i), 1);
          if (I("hit_station", i) == 3 && I("hit_ring", i) == 2)
            ChamberBXPos32->Fill(I("hit_chamber", i), I("hit_BX", i), 1);
          if (I("hit_station", i) == 4 && I("hit_ring", i) == 2)
            EtaBXPos42->Fill(I("hit_BX", i), F("hit_eta", i), 1);
          if (I("hit_station", i) == 3 && I("hit_ring", i) == 2)
            EtaBXPos32->Fill(I("hit_BX", i), F("hit_eta", i), 1);
        }
        if (I("hit_endcap", i) < 0 && I("hit_neighbor", i) == 0) {
          if (I("hit_station", i) == 4 && I("hit_ring", i) == 2)
            Neg42->Fill(I("hit_chamber", i), 1);
          if (I("hit_station", i) == 4 && I("hit_ring", i) == 1)
            Neg41->Fill(I("hit_chamber", i), 1);
          if (I("hit_station", i) == 3 && I("hit_ring", i) == 2)
            Neg32->Fill(I("hit_chamber", i), 1);
          if (I("hit_station", i) == 3 && I("hit_ring", i) == 1)
            Neg31->Fill(I("hit_chamber", i), 1);
          if (I("hit_station", i) == 2 && I("hit_ring", i) == 2)
            Neg22->Fill(I("hit_chamber", i), 1);
          if (I("hit_station", i) == 4 && I("hit_ring", i) == 2)
            ChamberBXNeg42->Fill(I("hit_chamber", i), I("hit_BX", i), 1);
          if (I("hit_station", i) == 3 && I("hit_ring", i) == 2)
            ChamberBXNeg32->Fill(I("hit_chamber", i), I("hit_BX", i), 1);
          if (I("hit_station", i) == 4 && I("hit_ring", i) == 2)
            EtaBXNeg42->Fill(I("hit_BX", i), F("hit_eta", i), 1);
          if (I("hit_station", i) == 3 && I("hit_ring", i) == 2)
            EtaBXNeg32->Fill(I("hit_BX", i), F("hit_eta", i), 1);
        }
        ...
        if (verbose)
          std::cout << " * RPC hit with BX = " << I("hit_BX", i)
                    << ", endcap = " << I("hit_endcap", i)
                    << ", station = " << I("hit_station", i)
                    << ", ring = " << I("hit_ring", i) << std::endl;
      }
    ...
    if (verbose)
      std::cout << "\n"
                << I("nTracks") << " emulated EMTF tracks in the event"
                << std::endl;
    if (I("nTracks") != VF("trk_pt")->size()) // From Read_FlatNtuple.h, can use
                                              // 'VF("branch_name")' to get a
                                              // vector of floats
      throw std::out_of_range(
          "nTracks does not equal size of vector of tracks");
    for (int i = 0; i < I("nTracks"); i++) {
      // // From Read_FlatNtuple.h, can use '("branch_name", i)' to get the ith
      // element of a vector of ints
      if (verbose)
        std::cout << " * Mode " << I("trk_mode", i)
                  << " track with BX = " << I("trk_BX", i)
                  << ", pT = " << F("trk_pt", i)
                  << ", eta = " << F("trk_eta", i)
                  << ", phi = " << F("trk_phi", i)
                  << ", maximum dPhi_int among hits = " << I("trk_dPhi_int", i)
                  << std::endl;
    }
    ...
    if (verbose)
      std::cout << "\n"
                << I("nUnpTracks") << " unpacked EMTF tracks in the event"
                << std::endl;
    for (int i = 0; i < I("nUnpTracks"); i++) {

      if (verbose)
        std::cout << " * Mode " << I("unp_trk_mode", i)
                  << " track with BX = " << I("unp_trk_BX", i)
                  << ", pT = " << F("unp_trk_pt", i)
                  << ", eta = " << F("unp_trk_eta", i)
                  << ", phi = " << F("unp_trk_phi", i)
                  << ", maximum dPhi_int among hits = "
                  << I("unp_trk_dPhi_int", i) << std::endl;
      ...
      if (I("unp_trk_dBX", i) > 1)
        TrackPTdBX->Fill(F("unp_trk_pt", i), 1);
      if (I("unp_trk_dPhi_int", i) > 300)
        TrackPTdPhi->Fill(F("unp_trk_pt", i), 1);
      if (I("unp_trk_dTheta_int", i) > 10)
        TrackPTdTheta->Fill(F("unp_trk_pt", i), 1);
      ...
      for (int j = 0; j < I("unp_trk_nHits", i); j++) {
        if (I("unp_trk_found_hits", i) != 1)
          continue; // For a very small fraction of unpacked tracks, can't find
                    // all hits (mostly BX != 0)
        int iHit = I("unp_trk_iHit", i,
                     j); // Access the index of each hit in the track
        if (I("hit_isCSC", iHit) == 1) {
          ...
          if (I("hit_station", iHit) == 4 && I("hit_ring", iHit) == 2)
            TrackLCTBX42->Fill(I("hit_BX", iHit), 1);
          TrackLCTBX42->GetXaxis()->SetTitle("BX");
          TrackLCTBX42->GetYaxis()->SetTitle("Entries");
          if (I("hit_station", iHit) == 4 && I("hit_ring", iHit) == 2 &&
              F("unp_trk_pt", i) > 25)
            TrackLCTBX42HiPt->Fill(I("hit_BX", iHit), 1);
          ...
          //                :)START(:                //
          /////////////////////////////////////////////
          if (F("unp_trk_pt", i) > 22 && fabs(I("unp_trk_BX", i)) < 2 &&
              I("unp_trk_nRPC", i) == 0 && I("unp_trk_found_hits", i) == 1 &&
              I("unp_trk_nHits", i) == 3) {
            if (I("hit_station", iHit) == 1)
              station1ThetaInt = I("hit_theta_int", iHit);
            if (I("hit_station", iHit) == 2)
              station2ThetaInt = I("hit_theta_int", iHit);
            if (I("hit_station", iHit) == 3)
              station3ThetaInt = I("hit_theta_int", iHit);
            if (I("hit_station", iHit) == 4)
              station4ThetaInt = I("hit_theta_int", iHit);
            dThetaFlag3 = 1;
            if (station1ThetaInt != -900 && station2ThetaInt != -900)
              dTheta1x = fabs(station1ThetaInt - station2ThetaInt);
            if (station1ThetaInt != -900 && station3ThetaInt != -900 &&
                fabs(station1ThetaInt - station3ThetaInt) > dTheta1x)
              dTheta1x = fabs(station1ThetaInt - station3ThetaInt);
            if (station1ThetaInt != -900 && station4ThetaInt != -900 &&
                fabs(station1ThetaInt - station4ThetaInt) > dTheta1x)
              dTheta1x = fabs(station1ThetaInt - station4ThetaInt);
            if (station2ThetaInt != -900 && station3ThetaInt != -900)
              dThetaxy = fabs(station2ThetaInt - station3ThetaInt);
            if (station2ThetaInt != -900 && station4ThetaInt != -900 &&
                fabs(station2ThetaInt - station4ThetaInt) > dThetaxy)
              dThetaxy = fabs(station2ThetaInt - station4ThetaInt);
            if (station3ThetaInt != -900 && station4ThetaInt != -900 &&
                fabs(station3ThetaInt - station4ThetaInt) > dThetaxy)
              dThetaxy = fabs(station3ThetaInt - station4ThetaInt);
          }
          if (F("unp_trk_pt", i) > 22 && fabs(I("unp_trk_BX", i)) < 2 &&
              I("unp_trk_nRPC", i) == 0 && I("unp_trk_found_hits", i) == 1 &&
              I("unp_trk_nHits", i) == 4) {
            ...
            dThetaFlag4 = 1;
            if (station1ThetaInt != -900 && station2ThetaInt != -900)
              dTheta41x = fabs(station1ThetaInt - station2ThetaInt);
            if (station1ThetaInt != -900 && station3ThetaInt != -900 &&
                fabs(station1ThetaInt - station3ThetaInt) > dTheta41x)
              dTheta41x = fabs(station1ThetaInt - station3ThetaInt);
            if (station1ThetaInt != -900 && station4ThetaInt != -900 &&
                fabs(station1ThetaInt - station4ThetaInt) > dTheta41x)
              dTheta41x = fabs(station1ThetaInt - station4ThetaInt);
            if (station2ThetaInt != -900 && station3ThetaInt != -900)
              dTheta4xy = fabs(station2ThetaInt - station3ThetaInt);
            if (station2ThetaInt != -900 && station4ThetaInt != -900 &&
                fabs(station2ThetaInt - station4ThetaInt) > dTheta4xy)
              dTheta4xy = fabs(station2ThetaInt - station4ThetaInt);
            if (station3ThetaInt != -900 && station4ThetaInt != -900 &&
                fabs(station3ThetaInt - station4ThetaInt) > dTheta4xy)
              dTheta4xy = fabs(station3ThetaInt - station4ThetaInt);
          }
          ////////////Chad fills dTheta plots//////////
          //                 :(END):                 //
          /////////////////////////////////////////////
          ...
          if (I("unp_trk_nHits", i) == 4 /*&& I("unp_trk_endcap",i)>0*/) {
            if (I("hit_station", iHit) == 1 /*&& F("unp_trk_pt", i)>25 */ &&
                I("unp_trk_dBX", i) > 1 && I("unp_trk_dPhi_int", i) > 300 &&
                I("unp_trk_dTheta_int", i) > 10) {
              ME1BX = I("hit_BX", iHit);
              ME1Phi = I("hit_phi_int", iHit);
              ME1Theta = I("hit_theta_int", iHit);
            } else if (I("hit_station", iHit) == 2 /*&& F("unp_trk_pt", i)>25 */
                       && I("unp_trk_dBX", i) > 1 &&
                       I("unp_trk_dPhi_int", i) > 300 &&
                       I("unp_trk_dTheta_int", i) > 10) {
              ME2BX = I("hit_BX", iHit);
              ME2Phi = I("hit_phi_int", iHit);
              ME2Theta = I("hit_theta_int", iHit);
            } else if (I("hit_station", iHit) == 3 /*&& F("unp_trk_pt", i)>25 */
                       && I("unp_trk_dBX", i) > 1 &&
                       I("unp_trk_dPhi_int", i) > 300 &&
                       I("unp_trk_dTheta_int", i) > 10) {
              ME3BX = I("hit_BX", iHit);
            ...
            } else if (I("hit_station", iHit) == 4 /*&& F("unp_trk_pt", i)>25 */
                       && I("unp_trk_dBX", i) > 1 &&
                       I("unp_trk_dPhi_int", i) > 300 &&
                       I("unp_trk_dTheta_int", i) > 10) {
              ME4BX = I("hit_BX", iHit);
          ...
          if (/*I("unp_trk_nRPC",i)==0 &&*/ I("unp_trk_nHits", i) >= 3 &&
            ...
            if (I("hit_station", iHit) == 1 && I("hit_ring", iHit) == 1 &&
                I("hit_pattern", iHit) < 6) {
            } else {
          ...
          if (verbose)
            std::cout << "  - CSC LCT with BX = " << I("hit_BX", iHit)
                      << ", endcap = " << I("hit_endcap", iHit)
                      << ", station = " << I("hit_station", iHit)
                      << ", ring = " << I("hit_ring", iHit) << std::endl;
        } else if (I("hit_isRPC", iHit) == 1) {
          if (verbose)
            std::cout << "  - RPC hit with BX = " << I("hit_BX", iHit)
                      << ", endcap = " << I("hit_endcap", iHit)
                      << ", station = " << I("hit_station", iHit)
                      << ", ring = " << I("hit_ring", iHit) << std::endl;
        }
      ...
      // Alex PU rate study no pairs
      if (/*I("unp_trk_nRPC",i)==0 &&*/ I("unp_trk_nHits", i) >= 3) {
        if(pairs > 0) {
          SingleMuPtAllWPair->Fill(F("unp_trk_pt", i), 1);
          if(F("unp_trk_pt", i) < 22) {
            SingleMuPtLoWPair->Fill(F("unp_trk_pt", i), 1);
          } else {
            SingleMuPtHiWPair->Fill(F("unp_trk_pt", i), 1);
          }
        } else {
          SingleMuPtAllNoPair->Fill(F("unp_trk_pt", i), 1);
          if(F("unp_trk_pt", i) < 22) {
            SingleMuPtLoNoPair->Fill(F("unp_trk_pt", i), 1);
          } else {
            SingleMuPtHiNoPair->Fill(F("unp_trk_pt", i), 1);
          }
        }
      }
