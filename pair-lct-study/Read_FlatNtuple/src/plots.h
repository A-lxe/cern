...
TH1D *SingleMuPtAll =
    new TH1D("SingleMuonPtAll", "SingleMu Tracks vs pT", 100, 1, 101);
...
TH1D *AllLctTheta = new TH1D("AllLctTheta", "All LCTs Theta", 100, -50, 50);
TH1D *PhiPairLctTheta =
    new TH1D("PhiPairLctTheta", "Phi Pair LCTs Theta", 100, -50, 50);
TH1D *ThetaPairLctTheta =
    new TH1D("ThetaPairLctTheta", "Theta Pair LCTs Theta", 100, -50, 50);
TH1D *QuadLctTheta = new TH1D("QuadLctTheta", "Quad LCTs Theta", 100, -50, 50);
...
TH1D *AllLctThetaAllPt =
    new TH1D("AllLctThetaAllPt", "All LCTs Theta All pT", 100, -50, 50);
TH1D *PhiPairLctThetaAllPt = new TH1D(
    "PhiPairLctThetaAllPt", "Phi Pair LCTs Theta All pT", 100, -50, 50);
TH1D *ThetaPairLctThetaAllPt = new TH1D(
    "ThetaPairLctThetaAllPt", "Theta Pair LCTs Theta All pT", 100, -50, 50);
TH1D *QuadLctThetaAllPt =
    new TH1D("QuadLctThetaAllPt", "Quad LCTs Theta All pT", 100, -50, 50);
...
TH1D *AllLctThetaLowPt =
    new TH1D("AllLctThetaLowPt", "All LCTs Theta Low pT", 100, -50, 50);
TH1D *PhiPairLctThetaLowPt = new TH1D(
    "PhiPairLctThetaLowPt", "Phi Pair LCTs Theta Low pT", 100, -50, 50);
TH1D *ThetaPairLctThetaLowPt = new TH1D(
    "ThetaPairLctThetaLowPt", "Theta Pair LCTs Theta Low pT", 100, -50, 50);
TH1D *QuadLctThetaLowPt =
    new TH1D("QuadLctThetaLowPt", "Quad LCTs Theta Low pT", 100, -50, 50);
...
TH1D *AllLctThetaHighPt =
    new TH1D("AllLctThetaHighPt", "All LCTs Theta High pT", 100, -50, 50);
TH1D *PhiPairLctThetaHighPt = new TH1D(
    "PhiPairLctThetaHighPt", "Phi Pair LCTs Theta High pT", 100, -50, 50);
TH1D *ThetaPairLctThetaHighPt = new TH1D(
    "ThetaPairLctThetaHighPt", "Theta Pair LCTs Theta High pT", 100, -50, 50);
TH1D *QuadLctThetaHighPt =
    new TH1D("QuadLctThetaHighPt", "Quad LCTs Theta High pT", 100, -50, 50);

// Pair Deltas
f->mkdir("Pair Deltas")->cd();

TH1D *PhiPairDTheta =
    new TH1D("PhiPairDTheta", "Phi Pair LCT dTheta", 30, 0, 30);
TH1D *PhiPairDWire =
...
TH1D *PhiPairTrackHiPtDTheta =
    new TH1D("PhiPairTrackHiPtDTheta",
             "Phi Pair LCT in Track (pT >= 22) dTheta", 30, 0, 30);
...
TH1D *PhiPairTrackAllPtDTheta = new TH1D(
    "PhiPairTrackAllPtDTheta", "Phi Pair LCT in Track dTheta", 30, 0, 30);
