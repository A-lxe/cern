...
std::vector<TString> ints = {{"evt_run", "evt_LS", "evt_BX", "nSimHits",
                              "nSimHitsCSC", "nSimHitsRPC", "nSimHitsBX0",
                              "nSimHitsCSCBX0", "nSimHitsRPCBX0", "nTracks",
                              "nTracksBX0", "nUnpTracks", "nUnpTracksBX0"}};
std::vector<TString> longs = {{"evt_event", "evt_orbit"}};
std::vector<TString> vFlt = {
    {"sim_hit_eta", "sim_hit_theta", "sim_hit_phi", "sim_hit_phi_loc",
     "hit_eta", "hit_theta", "hit_phi", "hit_phi_loc", "trk_pt", "reco_pt",
     "trk_eta", "trk_theta", "trk_phi", "trk_phi_loc", "unp_trk_pt",
     "unp_trk_eta", "unp_trk_theta", "unp_trk_phi", "unp_trk_phi_loc"}};
