...
TH1D *AllLctTheta = new TH1D("AllLctTheta", "All LCTs Theta", 500, 0, 501);
TH1D *PhiPairLctTheta =
    new TH1D("PhiPairLctTheta", "Phi Pair LCTs Theta", 500, 0, 501);
TH1D *ThetaPairLctTheta =
    new TH1D("ThetaPairLctTheta", "Theta Pair LCTs Theta", 500, 0, 501);
TH1D *QuadLctTheta = new TH1D("QuadLctTheta", "Quad LCTs Theta", 500, 0, 501);
...
TH1D *AllLctThetaAllPt =
    new TH1D("AllLctThetaAllPt", "All LCTs Theta All pT", 500, 0, 501);
TH1D *PhiPairLctThetaAllPt =
    new TH1D("PhiPairLctThetaAllPt", "Phi Pair LCTs Theta All pT", 500, 0, 501);
TH1D *ThetaPairLctThetaAllPt = new TH1D(
    "ThetaPairLctThetaAllPt", "Theta Pair LCTs Theta All pT", 500, 0, 501);
TH1D *QuadLctThetaAllPt =
    new TH1D("QuadLctThetaAllPt", "Quad LCTs Theta All pT", 500, 0, 501);
...
TH1D *AllLctThetaLowPt =
    new TH1D("AllLctThetaLowPt", "All LCTs Theta Low pT", 500, 0, 501);
TH1D *PhiPairLctThetaLowPt =
    new TH1D("PhiPairLctThetaLowPt", "Phi Pair LCTs Theta Low pT", 500, 0, 501);
TH1D *ThetaPairLctThetaLowPt = new TH1D(
    "ThetaPairLctThetaLowPt", "Theta Pair LCTs Theta Low pT", 500, 0, 501);
TH1D *QuadLctThetaLowPt =
    new TH1D("QuadLctThetaLowPt", "Quad LCTs Theta Low pT", 500, 0, 501);
...
TH1D *AllLctThetaHighPt =
    new TH1D("AllLctThetaHighPt", "All LCTs Theta High pT", 500, 0, 501);
TH1D *PhiPairLctThetaHighPt = new TH1D(
    "PhiPairLctThetaHighPt", "Phi Pair LCTs Theta High pT", 500, 0, 501);
TH1D *ThetaPairLctThetaHighPt = new TH1D(
    "ThetaPairLctThetaHighPt", "Theta Pair LCTs Theta High pT", 500, 0, 501);
TH1D *QuadLctThetaHighPt =
    new TH1D("QuadLctThetaHighPt", "Quad LCTs Theta High pT", 500, 0, 501);
...
TH1D *ThetaPairDPhi =
    new TH1D("ThetaPairDPhi", "Theta Pair LCT dPhi", 120, 0, 2000);
...
TH1D *PhiPairTrackHiPtDTheta =
    new TH1D("PhiPairTrackHiPtDTheta",
             "Phi Pair LCT in Track (pT >= 22) dTheta", 100, 0, 100);
...
TH1D *ThetaPairTrackHiPtDPhi =
    new TH1D("ThetaPairTrackHiPtDPhi",
             "Theta Pair LCT in Track (pT >= 22) dPhi", 120, 0, 2000);
TH1D *ThetaPairTrackHiPtDStrip =
    new TH1D("ThetaPairTrackHiPtDStrip",
             "Theta Pair LCT in Track (pT >= 22) dStrip", 200, 0, 200);

TH1D *PhiPairTrackAllPtDTheta = new TH1D(
    "PhiPairTrackAllPtDTheta", "Phi Pair LCT in Track dTheta", 100, 0, 100);
...
TH1D *ThetaPairTrackAllPtDPhi = new TH1D(
    "ThetaPairTrackAllPtDPhi", "Theta Pair LCT in Track dPhi", 120, 0, 2000);
...
TH2D *AllLctClctQualVsStat =
    new TH2D("AllLctClctQualVsStat", "All Lcts - Clct qual vs Station", 4, 1, 5,
             16, 0, 16);
for (int s = 1; s < 5; s++) {
  AllLctAlctQualityByStat[s - 1] = new TH1D(
      "AllLctAlctQualStat" + std::to_string(s),
      "All Lcts - Alct Qual - Station " + std::to_string(s), 16, 0, 16);
  AllLctClctQualityByStat[s - 1] = new TH1D(
      "AllLctClctQualStat" + std::to_string(s),
      "All Lcts - Clct Qual - Station " + std::to_string(s), 16, 0, 16);
  AllLctAlctVsClctByStat[s - 1] = new TH2D(
      "AllLctAlctVsClctStat" + std::to_string(s),
      "All Lcts - Alct qual vs Clct qual - Station " + std::to_string(s), 16, 0,
      16, 16, 0, 16);
}
...
for (int s = 1; s < 5; s++) {
  PhiPairAlctQualityByStat[s - 1] = new TH1D(
      "PhiPairAlctQualStat" + std::to_string(s),
      "Phi Pair Lcts - Alct Qual - Station " + std::to_string(s), 16, 0, 16);
  PhiPairClctQualityByStat[s - 1] = new TH1D(
      "PhiPairClctQualStat" + std::to_string(s),
      "Phi Pair Lcts - Clct Qual - Station " + std::to_string(s), 16, 0, 16);
  PhiPairAlctVsClctByStat[s - 1] = new TH2D(
      "PhiPairAlctVsClctStat" + std::to_string(s),
      "Phi Pair Lcts - Alct qual vs Clct qual - Station " + std::to_string(s),
      16, 0, 16, 16, 0, 16);
  PhiPairQual1VsQual2ByStat[s - 1] = new TH2D(
      "PhiPairQual1VsQual2Stat" + std::to_string(s),
      "Phi Pair Lcts - Qual 1 qual vs Qual 2 qual - Station " + std::to_string(s),
      16, 0, 16, 16, 0, 16);
  PhiPairAlct1VsAlct2ByStat[s - 1] = new TH2D(
      "PhiPairAlct1VsAlct2Stat" + std::to_string(s),
      "Phi Pair Lcts - Alct 1 qual vs Alct 2 qual - Station " + std::to_string(s),
      16, 0, 16, 16, 0, 16);
  PhiPairClct1VsClct2ByStat[s - 1] = new TH2D(
      "PhiPairClct1VsClct2Stat" + std::to_string(s),
      "Phi Pair Lcts - Clct 1 qual vs Clct 2 qual - Station " + std::to_string(s),
      16, 0, 16, 16, 0, 16);
}
...
TH2D *ThetaPairAlctQualVsStat =
    new TH2D("ThetaPairAlctQualVsStat", "Theta Pair Lcts - Alct qual vs Station", 4,
             1, 5, 16, 0, 16);
TH2D *ThetaPairClctQualVsStat =
    new TH2D("ThetaPairClctQualVsStat", "Theta Pair Lcts - Clct qual vs Station", 4,
             1, 5, 16, 0, 16);
for (int s = 1; s < 5; s++) {
  ThetaPairAlctQualityByStat[s - 1] = new TH1D(
      "ThetaPairAlctQualStat" + std::to_string(s),
      "Theta Pair Lcts - Alct Qual - Station " + std::to_string(s), 16, 0, 16);
  ThetaPairClctQualityByStat[s - 1] = new TH1D(
      "ThetaPairClctQualStat" + std::to_string(s),
      "Theta Pair Lcts - Clct Qual - Station " + std::to_string(s), 16, 0, 16);
  ThetaPairAlctVsClctByStat[s - 1] = new TH2D(
      "ThetaPairAlctVsClctStat" + std::to_string(s),
      "Theta Pair Lcts - Alct qual vs Clct qual - Station " + std::to_string(s),
      16, 0, 16, 16, 0, 16);
  ThetaPairQual1VsQual2ByStat[s - 1] = new TH2D(
      "ThetaPairQual1VsQual2Stat" + std::to_string(s),
      "Theta Pair Lcts - Qual 1 qual vs Qual 2 qual - Station " + std::to_string(s),
      16, 0, 16, 16, 0, 16);
  ThetaPairAlct1VsAlct2ByStat[s - 1] = new TH2D(
      "ThetaPairAlct1VsAlct2Stat" + std::to_string(s),
      "Theta Pair Lcts - Alct 1 qual vs Alct 2 qual - Station " + std::to_string(s),
      16, 0, 16, 16, 0, 16);
  ThetaPairClct1VsClct2ByStat[s - 1] = new TH2D(
      "ThetaPairClct1VsClct2Stat" + std::to_string(s),
      "Theta Pair Lcts - Clct 1 qual vs Clct 2 qual - Station " + std::to_string(s),
      16, 0, 16, 16, 0, 16);
}
...
TH2D *QuadClctQualVsStat =
    new TH2D("QuadClctQualVsStat", "Quad Lcts - Clct qual vs Station", 4, 1, 5,
             16, 0, 16);
for (int s = 1; s < 5; s++) {
  QuadAlctQualityByStat[s - 1] = new TH1D(
      "QuadAlctQualStat" + std::to_string(s),
      "Quad Lcts - Alct Qual - Station " + std::to_string(s), 16, 0, 16);
  QuadClctQualityByStat[s - 1] = new TH1D(
      "QuadClctQualStat" + std::to_string(s),
      "Quad Lcts - Clct Qual - Station " + std::to_string(s), 16, 0, 16);
  QuadAlctVsClctByStat[s - 1] = new TH2D(
      "QuadAlctVsClctStat" + std::to_string(s),
      "Quad Lcts - Alct qual vs Clct qual - Station " + std::to_string(s), 16,
      0, 16, 16, 0, 16);
}
